    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-8">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-6 md:p-8">
        <div className="text-center mb-6 md:mb-8">
          ...
          <p className="text-sm md:text-base text-gray-500">Sign in to continue to Udaan</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 md:space-y-6">
          <div>
            ...
            <input
              type="email"
              required
              className="w-full px-4 py-2.5 md:py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none text-base"
              value={email}
